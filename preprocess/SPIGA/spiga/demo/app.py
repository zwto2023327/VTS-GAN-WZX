...
def main():
    ...
    pars.add_argument('-i', '--input', type=str, default='/data/wzx/VTS-GAN-WZX/data/align_results/s1/video/bbaf2n.mp4', help='Video input')
    pars.add_argument('-d', '--dataset', type=str, default='merlrav',
    ...
    pars.add_argument('--outpath', type=str, default='/data/wzx/VTS-GAN-WZX/preprocess/', help='Video output directory')
