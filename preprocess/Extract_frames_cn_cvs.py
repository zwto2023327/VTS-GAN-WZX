...
def parse_args():
    ...
    parser.add_argument('--Data_dir', type=str, default="Data dir to GRID_corpus")
...
vid_files = sorted(glob.glob(os.path.join(args.Data_dir, '*', 'video', '*.mp4')))   #suppose the directory: Data_dir/subject/video/mpg files
