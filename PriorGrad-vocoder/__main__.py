...
if __name__ == '__main__':
  ...
  parser.add_argument('model_dir',default='/data/wzx/VTS-GAN-WZX/data/checkpoints/priorgrad',
      help='directory in which to store model checkpoints and training logs')
  parser.add_argument('data_root',default='/data/LJSpeech-1.1',
      help='root of the dataset. used to save the statistics for PriorGrad.'
           'example: for LJSpeech, specify /path/to/your/LJSpeech-1.1')
  parser.add_argument('filelist',default='/data/wzx/VTS-GAN-WZX/PriorGrad-vocoder/filelists',
